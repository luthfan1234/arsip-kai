                    ...
                    <div class="p-6">
                        <form @submit.prevent="submit">
                            ...
                            <div class="flex items-center justify-end mt-4">
                                <Link :href="route('divisions.index')" class="text-sm text-gray-600 hover:text-gray-900 mr-4">Batal</Link>
                                <button type="submit" :disabled="form.processing" class="px-4 py-2 bg-blue-600 text-white rounded-md">Simpan</button>
                            </div>
                        </form>
                    </div>
                </div>
